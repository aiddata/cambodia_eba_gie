...
est sto a2
outreg2 using "Results/cdb_outcomes/electricity_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", N) keep(time_to_trt)
reghdfe electric_dummy time_to_trt i.year, cluster(commune_number year) absorb(village_code)
est sto a3
outreg2 using "Results/cdb_outcomes/electricity_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", Y) keep(time_to_trt)
...
est sto b2
outreg2 using "Results/cdb_outcomes/infant_mortality_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", N) keep(time_to_trt)
reghdfe infant_mort time_to_trt i.year, cluster(commune_number year) absorb(village_code)
est sto b3
outreg2 using "Results/cdb_outcomes/infant_mortality_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", Y) keep(time_to_trt)

xtivreg2 hrs_road time_to_trt, fe cluster(commune_number year)
est sto c1
outreg2 using "Results/cdb_outcomes/time_to_road_outcome.doc", replace noni addtext("Year FEs", N, "Village FEs", N)
xi:xtivreg2 hrs_road time_to_trt i.year, fe cluster(commune_number year)
est sto c2
outreg2 using "Results/cdb_outcomes/time_to_road_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", N) keep(time_to_trt)
reghdfe hrs_road time_to_trt i.year, cluster(commune_number year) absorb(village_code)
est sto c3
outreg2 using "Results/cdb_outcomes/time_to_road_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", Y) keep(time_to_trt)
...
* su hors_fami
* replace hors_fami = r(mean) if hors_fami==.
...
foreach i of local varlist {
	* egen max_var = max(`i'), by(village_code)
...
est sto d2
outreg2 using "Results/cdb_outcomes/household_wealth_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", N) keep(time_to_trt)
reghdfe hh_wealth time_to_trt i.year, cluster(commune_number year) absorb(village_code)
est sto d3
outreg2 using "Results/cdb_outcomes/household_wealth_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", Y) keep(time_to_trt)
...
est sto e2
outreg2 using "Results/cdb_outcomes/princ_comp_1_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", N) keep(time_to_trt)
reghdfe pc1 time_to_trt i.year, cluster(commune_number year) absorb(village_code)
est sto e3
outreg2 using "Results/cdb_outcomes/princ_comp_1_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", Y) keep(time_to_trt)
...
est sto f2
outreg2 using "Results/cdb_outcomes/princ_comp_2_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", N) keep(time_to_trt)
reghdfe pc2 time_to_trt i.year, cluster(commune_number year) absorb(village_code)
est sto f3
outreg2 using "Results/cdb_outcomes/princ_comp_2_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", Y) keep(time_to_trt)

xtivreg2 pc3 time_to_trt, fe cluster(commune_number year)
est sto g1
outreg2 using "Results/cdb_outcomes/princ_comp_3_outcome.doc", replace noni addtext("Year FEs", N, "Village FEs", N) keep(time_to_trt)
xi:xtivreg2 pc3 time_to_trt i.year, fe cluster(commune_number year)
est sto g2
outreg2 using "Results/cdb_outcomes/princ_comp_3_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", N) keep(time_to_trt)
reghdfe pc3 time_to_trt i.year, cluster(commune_number year) absorb(village_code)
est sto g3
outreg2 using "Results/cdb_outcomes/princ_comp_3_outcome.doc", append noni addtext("Year FEs", Y, "Village FEs", Y) keep(time_to_trt)
