...
cd "/Users/christianbaehr/Box Sync/cambodia_eba_gie/Results/binary_treatment/additional_models"
...
cgmreg border_cell_treatment intra_cell_treatment, cluster(commune_number year)
est sto a1
outreg2 using "alternate_dep_vars/border_cell_treatment_dv.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
reghdfe border_cell_treatment intra_cell_treatment, cluster(commune_number year) absorb(year)
est sto a2
...
cgmreg intra_cell_treatment border_cell_treatment, cluster(commune_number year)
est sto b1
outreg2 using "alternate_dep_vars/intra_cell_treatment_dv.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_treatment' refers to the treatment variable that only considers villages within a cell. 'border_cell_treatment' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe intra_cell_treatment border_cell_treatment, cluster(commune_number year) absorb(year)
est sto b2
...
est sto c1
outreg2 using "omit_border_cell_treatment/no_border_cell_treatment_dummy_models.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_treatment' refers to the treatment variable that only considers villages within a cell. 'border_cell_treatment' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl_dummy intra_cell_treatment, cluster(commune_number year) absorb(year)
est sto c2
...
est sto d1
outreg2 using "omit_border_cell_treatment/no_border_cell_treatment_binned_models.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_treatment' refers to the treatment variable that only considers villages within a cell. 'border_cell_treatment' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl_binned intra_cell_treatment, cluster(commune_number year) absorb(year)
est sto d2
...
est sto e1
outreg2 using "omit_border_cell_treatment/no_border_cell_treatment_continuous_models.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_treatment' refers to the treatment variable that only considers villages within a cell. 'border_cell_treatment' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl intra_cell_treatment, cluster(commune_number year) absorb(year)
est sto e2
...
cgmreg ntl_standardized intra_cell_treatment, cluster(commune_number year)
est sto f1
outreg2 using "omit_border_cell_treatment/no_border_cell_treatment_standardized_models.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_treatment' refers to the treatment variable that only considers villages within a cell. 'border_cell_treatment' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl_standardized intra_cell_treatment, cluster(commune_number year) absorb(year)
est sto f2
...
cgmreg ntl_dummy border_cell_treatment, cluster(commune_number year)
est sto g1
outreg2 using "omit_intra_cell_treatment/no_intra_cell_treatment_dummy_models.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_treatment' refers to the treatment variable that only considers villages within a cell. 'border_cell_treatment' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl_dummy border_cell_treatment, cluster(commune_number year) absorb(year)
est sto g2
...
cgmreg ntl_binned border_cell_treatment, cluster(commune_number year)
est sto h1
outreg2 using "omit_intra_cell_treatment/no_intra_cell_treatment_binned_models.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_treatment' refers to the treatment variable that only considers villages within a cell. 'border_cell_treatment' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl_binned border_cell_treatment, cluster(commune_number year) absorb(year)
est sto h2
...
cgmreg ntl border_cell_treatment, cluster(commune_number year)
est sto j1
outreg2 using "omit_intra_cell_treatment/no_intra_cell_treatment_continuous_models.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_treatment' refers to the treatment variable that only considers villages within a cell. 'border_cell_treatment' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl border_cell_treatment, cluster(commune_number year) absorb(year)
est sto j2
...
cgmreg ntl_standardized border_cell_treatment, cluster(commune_number year)
est sto k1
outreg2 using "omit_intra_cell_treatment/no_intra_cell_treatment_standardized_models.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_treatment' refers to the treatment variable that only considers villages within a cell. 'border_cell_treatment' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl_standardized border_cell_treatment, cluster(commune_number year) absorb(year)
est sto k2
...
cgmreg ntl_dummy intra_cell_treatment if year<=2009, cluster(commune_number year)
est sto m1
outreg2 using "pre_2010/pre2010_camb_models_dummy.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
cgmreg ntl_dummy intra_cell_treatment border_cell_treatment if year<=2009, fe cluster(commune_number year)
est sto m2
outreg2 using "pre_2010/pre2010_camb_models_dummy.doc", append noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
reghdfe ntl_dummy intra_cell_treatment border_cell_treatment if year<=2009, cluster(commune_number year) absorb(year)
est sto m3
...
cgmreg ntl_binned intra_cell_treatment if year<=2009, cluster(commune_number year)
est sto n1
outreg2 using "pre_2010/pre2010_camb_models_binned.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
cgmreg ntl_binned intra_cell_treatment border_cell_treatment if year<=2009, cluster(commune_number year)
est sto n2
outreg2 using "pre_2010/pre2010_camb_models_binned.doc", append noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
reghdfe ntl_binned intra_cell_treatment border_cell_treatment if year<=2009, cluster(commune_number year) absorb(year)
est sto n3
...
cgmreg ntl intra_cell_treatment if year<=2009, cluster(commune_number year)
est sto p1
outreg2 using "pre_2010/pre2010_camb_models_continuous.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
cgmreg ntl intra_cell_treatment border_cell_treatment if year<=2009, cluster(commune_number year)
est sto p2
outreg2 using "pre_2010/pre2010_camb_models_continuous.doc", append noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
reghdfe ntl intra_cell_treatment border_cell_treatment if year<=2009, cluster(commune_number year) absorb(year)
est sto p3
...
cgmreg ntl_standardized intra_cell_treatment if year<=2009, cluster(commune_number year)
est sto q1
outreg2 using "pre_2010/pre2010_camb_models_standardized.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
cgmreg ntl_standardized intra_cell_treatment border_cell_treatment if year<=2009, cluster(commune_number year)
est sto q2
outreg2 using "pre_2010/pre2010_camb_models_standardized.doc", append noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
reghdfe ntl_standardized intra_cell_treatment border_cell_treatment if year<=2009, cluster(commune_number year) absorb(year)
est sto q3
