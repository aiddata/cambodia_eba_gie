...
insheet using "ProcessedData/heterogeneous_effects/panel_rural_domestic_water_only.csv", clear
...
est sto a1
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_dummy_count.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
est sto a2
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_dummy_count.doc", append noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
xi:xtivreg2 ntl_dummy pointcount boxcount i.year, fe cluster(communenumber year)
est sto a3
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_dummy_count.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount boxcount)
reghdfe ntl_dummy pointcount boxcount i.year, cluster(communenumber year) absorb(cell_id)
est sto a4
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_dummy_count.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) /// 
	keep(pointcount boxcount)
reghdfe ntl_dummy pointcount boxcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto a5
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_dummy_count.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) /// 
	keep(pointcount boxcount)
reghdfe ntl_dummy pointcount boxcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto a6
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_dummy_count.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) /// 
	keep(pointcount boxcount)
...
est sto b1
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_binned_count.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
est sto b2
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_binned_count.doc", append noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
xi:xtivreg2 ntl_binned pointcount boxcount i.year, fe cluster(communenumber year)
est sto b3
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_binned_count.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) /// 
	keep(pointcount boxcount)
reghdfe ntl_binned pointcount boxcount i.year, cluster(communenumber year) absorb(cell_id)
est sto b4
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_binned_count.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount boxcount)
reghdfe ntl_binned pointcount boxcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto b5
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_binned_count.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount boxcount)
reghdfe ntl_binned pointcount boxcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto b6
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_binned_count.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount boxcount)
...
est sto c1
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_continuous_count.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
est sto c2
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_continuous_count.doc", append noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
xi:xtivreg2 ntl pointcount boxcount i.year, fe cluster(communenumber year)
est sto c3
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_continuous_count.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount boxcount)
reghdfe ntl pointcount boxcount i.year, cluster(communenumber year) absorb(cell_id)
est sto c4
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_continuous_count.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount boxcount)
reghdfe ntl pointcount boxcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto c5
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_continuous_count.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount boxcount)
reghdfe ntl pointcount boxcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto c6
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_continuous_count.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount boxcount)
...
est sto d1
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_standardized_count.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
est sto d2
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_standardized_count.doc", append noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
xi:xtivreg2 ntl_standardized pointcount boxcount i.year, fe cluster(communenumber year)
est sto d3
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_standardized_count.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount boxcount)
reghdfe ntl_standardized pointcount boxcount i.year, cluster(communenumber year) absorb(cell_id)
est sto d4
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_standardized_count.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount boxcount)
reghdfe ntl_standardized pointcount boxcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto d5
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_standardized_count.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount boxcount)
reghdfe ntl_standardized pointcount boxcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto d6
outreg2 using "heterogeneous_effects/rural_domestic_water/rural_domestic_water_standardized_count.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount boxcount)
