...
est sto a1
outreg2 using "Results/heterogeneous_effects/irrigation/irrigation_ntl_dummy.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
est sto a2
outreg2 using "Results/heterogeneous_effects/irrigation/irrigation_ntl_dummy.doc", append noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
...
est sto b1
outreg2 using "Results/heterogeneous_effects/irrigation/irrigation_ntl_binned.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
est sto b2
outreg2 using "Results/heterogeneous_effects/irrigation/irrigation_ntl_binned.doc", append noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
...
est sto c1
outreg2 using "Results/heterogeneous_effects/irrigation/irrigation_ntl_continuous.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
est sto c2
outreg2 using "Results/heterogeneous_effects/irrigation/irrigation_ntl_continuous.doc", append noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
