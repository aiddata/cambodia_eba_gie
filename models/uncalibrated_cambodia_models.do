...
est sto a1
outreg2 using "Results/uncalibrated/uncalib_camb_models_dummy.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
est sto a2
outreg2 using "Results/uncalibrated/uncalib_camb_models_dummy.doc", append noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
xi:xtivreg2 ntl_dummy within_trt border_trt i.year, fe cluster(communenumber year)
est sto a3
outreg2 using "Results/uncalibrated/uncalib_camb_models_dummy.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(within_trt border_trt)
reghdfe ntl_dummy within_trt border_trt i.year, cluster(communenumber year) absorb(cell_id)
est sto a4
outreg2 using "Results/uncalibrated/uncalib_camb_models_dummy.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) /// 
	keep(within_trt border_trt)
reghdfe ntl_dummy within_trt border_trt i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto a5
outreg2 using "Results/uncalibrated/uncalib_camb_models_dummy.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) /// 
	keep(within_trt border_trt)
reghdfe ntl_dummy within_trt border_trt c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto a6
outreg2 using "Results/uncalibrated/uncalib_camb_models_dummy.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) /// 
	keep(within_trt border_trt)
...
est sto b1
outreg2 using "Results/uncalibrated/uncalib_camb_models_binned.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
est sto b2
outreg2 using "Results/uncalibrated/uncalib_camb_models_binned.doc", append noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
xi:xtivreg2 ntl_binned within_trt border_trt i.year, fe cluster(communenumber year)
est sto b3
outreg2 using "Results/uncalibrated/uncalib_camb_models_binned.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) /// 
	keep(within_trt border_trt)
reghdfe ntl_binned within_trt border_trt i.year, cluster(communenumber year) absorb(cell_id)
est sto b4
outreg2 using "Results/uncalibrated/uncalib_camb_models_binned.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(within_trt border_trt)
reghdfe ntl_binned within_trt border_trt i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto b5
outreg2 using "Results/uncalibrated/uncalib_camb_models_binned.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(within_trt border_trt)
reghdfe ntl_binned within_trt border_trt c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto b6
outreg2 using "Results/uncalibrated/uncalib_camb_models_binned.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(within_trt border_trt)
...
est sto c1
outreg2 using "Results/uncalibrated/uncalib_camb_models_continuous.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
est sto c2
outreg2 using "Results/uncalibrated/uncalib_camb_models_continuous.doc", append noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
xi:xtivreg2 ntl within_trt border_trt i.year, fe cluster(communenumber year)
est sto c3
outreg2 using "Results/uncalibrated/uncalib_camb_models_continuous.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(within_trt border_trt)
reghdfe ntl within_trt border_trt i.year, cluster(communenumber year) absorb(cell_id)
est sto c4
outreg2 using "Results/uncalibrated/uncalib_camb_models_continuous.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(within_trt border_trt)
reghdfe ntl within_trt border_trt i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto c5
outreg2 using "Results/uncalibrated/uncalib_camb_models_continuous.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(within_trt border_trt)
reghdfe ntl within_trt border_trt c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto c6
outreg2 using "Results/uncalibrated/uncalib_camb_models_continuous.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(within_trt border_trt)
...
est sto d1
outreg2 using "Results/uncalibrated/uncalib_camb_models_standardized.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
est sto d2
outreg2 using "Results/uncalibrated/uncalib_camb_models_standardized.doc", append noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
xi:xtivreg2 ntl_standardized within_trt border_trt i.year, fe cluster(communenumber year)
est sto d3
outreg2 using "Results/uncalibrated/uncalib_camb_models_standardized.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(within_trt border_trt)
reghdfe ntl_standardized within_trt border_trt i.year, cluster(communenumber year) absorb(cell_id)
est sto d4
outreg2 using "Results/uncalibrated/uncalib_camb_models_standardized.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(within_trt border_trt)
reghdfe ntl_standardized within_trt border_trt i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto d5
outreg2 using "Results/uncalibrated/uncalib_camb_models_standardized.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(within_trt border_trt)
reghdfe ntl_standardized within_trt border_trt c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto d6
outreg2 using "Results/uncalibrated/uncalib_camb_models_standardized.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(within_trt border_trt)
