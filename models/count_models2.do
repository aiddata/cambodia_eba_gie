...
cd "/Users/christianbaehr/Box Sync/cambodia_eba_gie/Results/count/additional_models"
...
est sto a1
outreg2 using "alternate_dep_vars/boxcount_dv.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
est sto a2
outreg2 using "alternate_dep_vars/boxcount_dv.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount)
reghdfe boxcount pointcount i.year, cluster(communenumber year) absorb(cell_id)
est sto a3
outreg2 using "alternate_dep_vars/boxcount_dv.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount)
reghdfe boxcount pointcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto a4
outreg2 using "alternate_dep_vars/boxcount_dv.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount)
reghdfe boxcount pointcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto a5
outreg2 using "alternate_dep_vars/boxcount_dv.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount)
...
est sto b1
outreg2 using "alternate_dep_vars/pointcount_dv.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'pointcount' refers to the treatment variable that only considers villages within a cell. 'boxcount' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
xi:xtivreg2 pointcount boxcount i.year, fe cluster(communenumber year)
est sto b2
outreg2 using "alternate_dep_vars/pointcount_dv.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(boxcount)
reghdfe pointcount boxcount i.year, cluster(communenumber year) absorb(cell_id)
est sto b3
outreg2 using "alternate_dep_vars/pointcount_dv.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(boxcount)
reghdfe pointcount boxcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto b4
outreg2 using "alternate_dep_vars/pointcount_dv.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(boxcount)
reghdfe pointcount boxcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto b5
outreg2 using "alternate_dep_vars/pointcount_dv.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(boxcount)
...
est sto c1
outreg2 using "omit_boxcount/no_boxcount_dummy_models.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'pointcount' refers to the treatment variable that only considers villages within a cell. 'boxcount' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
xi:xtivreg2 ntl_dummy pointcount i.year, fe cluster(communenumber year)
est sto c2
outreg2 using "omit_boxcount/no_boxcount_dummy_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount)
reghdfe ntl_dummy pointcount i.year, cluster(communenumber year) absorb(cell_id)
est sto c3
outreg2 using "omit_boxcount/no_boxcount_dummy_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount)
reghdfe ntl_dummy pointcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto c4
outreg2 using "omit_boxcount/no_boxcount_dummy_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount)
reghdfe ntl_dummy pointcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto c5
outreg2 using "omit_boxcount/no_boxcount_dummy_models.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount)

xtivreg2 ntl_binned pointcount, fe cluster(communenumber year)
est sto d1
outreg2 using "omit_boxcount/no_boxcount_binned_models.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'pointcount' refers to the treatment variable that only considers villages within a cell. 'boxcount' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
xi:xtivreg2 ntl_binned pointcount i.year, fe cluster(communenumber year)
est sto d2
outreg2 using "omit_boxcount/no_boxcount_binned_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount)
reghdfe ntl_binned pointcount i.year, cluster(communenumber year) absorb(cell_id)
est sto d3
outreg2 using "omit_boxcount/no_boxcount_binned_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount)
reghdfe ntl_binned pointcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto d4
outreg2 using "omit_boxcount/no_boxcount_binned_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount)
reghdfe ntl_binned pointcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto d5
outreg2 using "omit_boxcount/no_boxcount_binned_models.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount)

xtivreg2 ntl pointcount, fe cluster(communenumber year)
est sto e1
outreg2 using "omit_boxcount/no_boxcount_continuous_models.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'pointcount' refers to the treatment variable that only considers villages within a cell. 'boxcount' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
xi:xtivreg2 ntl pointcount i.year, fe cluster(communenumber year)
est sto e2
outreg2 using "omit_boxcount/no_boxcount_continuous_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount)
reghdfe ntl pointcount i.year, cluster(communenumber year) absorb(cell_id)
est sto e3
outreg2 using "omit_boxcount/no_boxcount_continuous_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount)
reghdfe ntl pointcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto e4
outreg2 using "omit_boxcount/no_boxcount_continuous_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount)
reghdfe ntl pointcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto e5
outreg2 using "omit_boxcount/no_boxcount_continuous_models.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount)

xtivreg2 ntl_standardized pointcount, fe cluster(communenumber year)
est sto f1
outreg2 using "omit_boxcount/no_boxcount_standardized_models.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'pointcount' refers to the treatment variable that only considers villages within a cell. 'boxcount' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
xi:xtivreg2 ntl_standardized pointcount i.year, fe cluster(communenumber year)
est sto f2
outreg2 using "omit_boxcount/no_boxcount_standardized_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount)
reghdfe ntl_standardized pointcount i.year, cluster(communenumber year) absorb(cell_id)
est sto f3
outreg2 using "omit_boxcount/no_boxcount_standardized_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(pointcount)
reghdfe ntl_standardized pointcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto f4
outreg2 using "omit_boxcount/no_boxcount_standardized_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount)
reghdfe ntl_standardized pointcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto f5
outreg2 using "omit_boxcount/no_boxcount_standardized_models.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(pointcount)
...
est sto g1
outreg2 using "omit_pointcount/no_pointcount_dummy_models.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'pointcount' refers to the treatment variable that only considers villages within a cell. 'boxcount' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
xi:xtivreg2 ntl_dummy boxcount i.year, fe cluster(communenumber year)
est sto g2
outreg2 using "omit_pointcount/no_pointcount_dummy_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(boxcount)
reghdfe ntl_dummy boxcount i.year, cluster(communenumber year) absorb(cell_id)
est sto g3
outreg2 using "omit_pointcount/no_pointcount_dummy_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(boxcount)
reghdfe ntl_dummy boxcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto g4
outreg2 using "omit_pointcount/no_pointcount_dummy_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(boxcount)
reghdfe ntl_dummy boxcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto g5
outreg2 using "omit_pointcount/no_pointcount_dummy_models.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(boxcount)

xtivreg2 ntl_binned boxcount, fe cluster(communenumber year)
est sto h1
outreg2 using "omit_pointcount/no_pointcount_binned_models.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'pointcount' refers to the treatment variable that only considers villages within a cell. 'boxcount' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
xi:xtivreg2 ntl_binned boxcount i.year, fe cluster(communenumber year)
est sto h2
outreg2 using "omit_pointcount/no_pointcount_binned_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(boxcount)
reghdfe ntl_binned boxcount i.year, cluster(communenumber year) absorb(cell_id)
est sto h3
outreg2 using "omit_pointcount/no_pointcount_binned_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(boxcount)
reghdfe ntl_binned boxcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto h4
outreg2 using "omit_pointcount/no_pointcount_binned_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(boxcount)
reghdfe ntl_binned boxcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto h5
outreg2 using "omit_pointcount/no_pointcount_binned_models.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(boxcount)

xtivreg2 ntl boxcount, fe cluster(communenumber year)
est sto j1
outreg2 using "omit_pointcount/no_pointcount_continuous_models.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'pointcount' refers to the treatment variable that only considers villages within a cell. 'boxcount' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
xi:xtivreg2 ntl boxcount i.year, fe cluster(communenumber year)
est sto j2
outreg2 using "omit_pointcount/no_pointcount_continuous_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(boxcount)
reghdfe ntl boxcount i.year, cluster(communenumber year) absorb(cell_id)
est sto j3
outreg2 using "omit_pointcount/no_pointcount_continuous_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(boxcount)
reghdfe ntl boxcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto j4
outreg2 using "omit_pointcount/no_pointcount_continuous_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(boxcount)
reghdfe ntl boxcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto j5
outreg2 using "omit_pointcount/no_pointcount_continuous_models.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(boxcount)

xtivreg2 ntl_standardized boxcount, fe cluster(communenumber year)
est sto k1
outreg2 using "omit_pointcount/no_pointcount_standardized_models.doc", replace noni addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'pointcount' refers to the treatment variable that only considers villages within a cell. 'boxcount' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
xi:xtivreg2 ntl_standardized boxcount i.year, fe cluster(communenumber year)
est sto k2
outreg2 using "omit_pointcount/no_pointcount_standardized_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	keep(boxcount)
reghdfe ntl_standardized boxcount i.year, cluster(communenumber year) absorb(cell_id)
est sto k3
outreg2 using "omit_pointcount/no_pointcount_standardized_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", N) ///
	keep(boxcount)
reghdfe ntl_standardized boxcount i.year c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto k4
outreg2 using "omit_pointcount/no_pointcount_standardized_models.doc", append noni addtext("Year FEs", Y, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(boxcount)
reghdfe ntl_standardized boxcount c.year#i.provincenumber, cluster(communenumber year) absorb(cell_id)
est sto k5
outreg2 using "omit_pointcount/no_pointcount_standardized_models.doc", append noni addtext("Year FEs", N, "Grid cell FEs", Y, "Lin. Time Trends by Prov.", Y) ///
	keep(boxcount)
