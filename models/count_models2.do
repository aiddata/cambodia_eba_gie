...
cgmreg ntl_dummy intra_cell_count if any_ntl>0, cluster(commune_number year)
est sto a1
outreg2 using "no_dark_subset/ntl_dummy.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
cgmreg ntl_dummy intra_cell_count border_cell_count if any_ntl>0, cluster(commune_number year)
est sto a2
outreg2 using "no_dark_subset/ntl_dummy.doc", append noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
reghdfe ntl_dummy intra_cell_count border_cell_count if any_ntl>0, cluster(commune_number year) absorb(year)
est sto a3
...
cgmreg ntl_binned intra_cell_count if any_ntl>0, cluster(commune_number year)
est sto b1
outreg2 using "no_dark_subset/ntl_binned.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_count' refers to the treatment variable that keeps a cumulative yearly count of completed projects within a cell. 'border_cell_count' refers to the treatment variable that keeps a cumulative yearly count of completed projects in the area surrounding a cell")
cgmreg ntl_binned intra_cell_count border_cell_count if any_ntl>0, cluster(commune_number year)
est sto b2
outreg2 using "no_dark_subset/ntl_binned.doc", append noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
reghdfe ntl_binned intra_cell_count border_cell_count if any_ntl>0, cluster(commune_number year) absorb(year)
est sto b3
...
cgmreg ntl intra_cell_count if any_ntl>0, cluster(commune_number year)
est sto c1
outreg2 using "no_dark_subset/ntl_continuous.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_count' refers to the treatment variable that keeps a cumulative yearly count of completed projects within a cell. 'border_cell_count' refers to the treatment variable that keeps a cumulative yearly count of completed projects in the area surrounding a cell")
cgmreg ntl intra_cell_count border_cell_count if any_ntl>0, cluster(commune_number year)
est sto c2
outreg2 using "no_dark_subset/ntl_continuous.doc", append noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
reghdfe ntl intra_cell_count border_cell_count if any_ntl>0, cluster(commune_number year) absorb(year)
est sto c3
...
cgmreg border_cell_count intra_cell_count, cluster(commune_number year)
est sto d1
outreg2 using "alternate_dep_vars/border-cell_outcome.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
reghdfe border_cell_count intra_cell_count, cluster(commune_number year) absorb(year)
est sto d2
...
cgmreg intra_cell_count border_cell_count, cluster(commune_number year)
est sto e1
outreg2 using "alternate_dep_vars/intra-cell_outcome.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_count' refers to the treatment variable that only considers villages within a cell. 'border_cell_count' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe intra_cell_count border_cell_count, cluster(commune_number year) absorb(year)
est sto e2
...
est sto f1
outreg2 using "omit_border_cell_trt/no-border-treatment_ntl_dummy.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_count' refers to the treatment variable that only considers villages within a cell. 'border_cell_count' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl_dummy intra_cell_count, cluster(commune_number year) absorb(year)
est sto f2
...
est sto g1
outreg2 using "omit_border_cell_trt/no-border-treatment_ntl_binned.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_count' refers to the treatment variable that only considers villages within a cell. 'border_cell_count' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl_binned intra_cell_count, cluster(commune_number year) absorb(year)
est sto g2
...
est sto h1
outreg2 using "omit_border_cell_trt/no-border-treatment_ntl_continuous.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_count' refers to the treatment variable that only considers villages within a cell. 'border_cell_count' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl intra_cell_count, cluster(commune_number year) absorb(year)
est sto h2
...
cgmreg ntl_dummy border_cell_count, cluster(commune_number year)
est sto j1
outreg2 using "omit_intra_cell_trt/no-intra-treatment_ntl_dummy.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_count' refers to the treatment variable that only considers villages within a cell. 'border_cell_count' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl_dummy border_cell_count, cluster(commune_number year) absorb(year)
est sto j2
...
cgmreg ntl_binned border_cell_count, cluster(commune_number year)
est sto k1
outreg2 using "omit_intra_cell_trt/no-intra-treatment_ntl_binned.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_count' refers to the treatment variable that only considers villages within a cell. 'border_cell_count' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl_binned border_cell_count, cluster(commune_number year) absorb(year)
est sto k2
...
cgmreg ntl border_cell_count, cluster(commune_number year)
est sto m1
outreg2 using "omit_intra_cell_trt/no-intra-treatment_ntl_continuous.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
	addnote("Notes: 'intra_cell_count' refers to the treatment variable that only considers villages within a cell. 'border_cell_count' refers to the treatment variable that only considers villages in the eight cells bordering a cell, but NOT within the cell itself.")
reghdfe ntl border_cell_count, cluster(commune_number year) absorb(year)
est sto m2
...
cgmreg ntl_dummy intra_cell_count if year<=2009, cluster(commune_number year)
est sto n1
outreg2 using "pre_2010/pre2010_ntl_dummy.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
cgmreg ntl_dummy intra_cell_count border_cell_count if year<=2009, cluster(commune_number year)
est sto n2
outreg2 using "pre_2010/pre2010_ntl_dummy.doc", append noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
reghdfe ntl_dummy intra_cell_count border_cell_count if year<=2009, cluster(commune_number year) absorb(year)
est sto n3
...
cgmreg ntl_binned intra_cell_count if year<=2009, cluster(commune_number year)
est sto p1
outreg2 using "pre_2010/pre2010_ntl_binned.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
cgmreg ntl_binned intra_cell_count border_cell_count if year<=2009, cluster(commune_number year)
est sto p2
outreg2 using "pre_2010/pre2010_ntl_binned.doc", append noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
reghdfe ntl_binned intra_cell_count border_cell_count if year<=2009, cluster(commune_number year) absorb(year)
est sto p3
...
cgmreg ntl intra_cell_count if year<=2009, cluster(commune_number year)
est sto q1
outreg2 using "pre_2010/pre2010_ntl_continuous.doc", replace noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N) ///
...
cgmreg ntl intra_cell_count border_cell_count if year<=2009, cluster(commune_number year)
est sto q2
outreg2 using "pre_2010/pre2010_ntl_continuous.doc", append noni nocons addtext("Year FEs", N, "Grid cell FEs", N, "Lin. Time Trends by Prov.", N)
reghdfe ntl intra_cell_count border_cell_count if year<=2009, cluster(commune_number year) absorb(year)
est sto q3
